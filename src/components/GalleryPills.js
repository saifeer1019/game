    ...
    <div className="w-full mb-4 sm:mb-2">
      <div className="flex flex-col gap-4 md:gap-4 md:gap-y-6">
        {games && games.slice(0, 5).map((game, idx) => (
          ...
          <div key={idx} className='flex justify-start gap-x-4 hover:bg-cyan-500/10 cursor-pointer border-b-1 py-2 mr-4  border-b-gray-300'>
          <div 
          className="relative overflow-hidden w-14 h-20 " >
              ...
              <div className='flex flex-col gap-2 self-center'>
               ...
               <p className='self-start mr-1 bg-[#e3b5cd] rounded-[5px] text-primary_ font-bold w-fit px-2 '>{game.data.category}</p>
